...
function twentytwelve_setup() {
	 ...
	 */
	load_theme_textdomain( 'briefpress' );
...
function twentytwelve_scripts_styles() {
	...
	// Loads mobile stylesheet.
	wp_enqueue_style( 'twentytwelve-mobile-style', get_template_directory_uri() . '/mobile.css', array( 'twentytwelve-style' ));
...
function twentytwelve_widgets_init() {
	register_sidebar( array(
		...
		'id' => 'sidebar-1',
		'description' => __( '右侧小工具', 'twentytwelve' ),
	...
	register_sidebar( array(
		'name' => __( '中部小工具', 'twentytwelve' ),
		'id' => 'sidebar-2',
		'description' => __( '中部三展示小工具', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
function twentytwelve_entry_meta() {
	...
	$author = sprintf( '<span class="author vcard"><a class="url fn n"  rel="author">%1$s</a></span>',
		get_the_author()
	);
	...
	$utility_text = __( '由<span class="by-author"> %1$s </span>提交于 %2$s', 'twentytwelve' );
